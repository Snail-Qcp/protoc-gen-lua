...
localTable.PERSON_PHONENUMBER_NUMBER_FIELD.label = 1
...
localTable.PERSON_PHONENUMBER_TYPE_FIELD.has_default_value = false
localTable.PERSON_PHONENUMBER_TYPE_FIELD.default_value = nil
...
localTable.PERSON_NAME_FIELD.label = 1
...
localTable.PERSON_ID_FIELD.label = 1
